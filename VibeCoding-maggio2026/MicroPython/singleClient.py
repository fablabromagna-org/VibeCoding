...
# Coda per gestire le connessioni attive
active_connections = []
...
async def main():
    ...
    t1 = asyncio.create_task(sensor_task())  # Task per il sensore
    t2 = asyncio.create_task(peripheral_task())  # Task per la pubblicità BLE e gestione delle connessioni
